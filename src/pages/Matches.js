...
function Matches() {
  const { currentUser , getUsersForMatchesPage } = useContext(UserContext)
  // const [finalUser, setFinalUser] = useState([]) 
  const [isLoading, setIsLoading] = useState(false)
  // console.log("userForMatchesPage" , userForMatchesPage)
  
  //putting context in array to map
  // const [usersToMap , setUsersToMatch] = useState([getUsersForMatchesPage])



  // useEffect(()=> {
  //   console.log(usersToMap , " I am the use effect with users for matches page")
  // }, [getUsersForMatchesPage]
  // )

  // const getPhotosForCards = () => {
  //   getUsersForMatchesPage
  // }
  ...
  if(!isLoading){
    return (
      ...
      <View style={{backgroundColor : "rgb(232, 86, 86)" , height: 1300}}>
        ...
        <Text style={{ color:"white" , fontSize:30}}>{currentUser.userName}'s Matches</Text>
